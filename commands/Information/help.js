    ...
    try {
      if (args[0]) {
        ...
        const embed = new MessageEmbed()
          ...
          .setTitle("Pomoc - NightOwl Bot")
          .setFooter(`Aby zobaczyć dokładne instrukcje co do komendy wpisz: ${config.prefix}help [NAZWAA KOMENDY]`, client.user.displayAvatarURL());
